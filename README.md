...
-----------
A powerful Telegram bot that tracks your friends' LeetCode progress in real-time and sends instant notifications when they solve problems!
...
🎬 Demo
```
User: /add john_doe John Doe
Bot: ✅ Added to your tracking list!

[5 minutes later...]
Bot: 🟡 John Doe just solved 1 Medium problem!
     📊 Total: 156 | Easy: 89 | Medium: 54 | Hard: 13
```
